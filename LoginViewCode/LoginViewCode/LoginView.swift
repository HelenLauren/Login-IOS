...
final class LoginView: UIView {
    ...
    let logoImageView: UIImageView = {
        ...
        iv.tintColor = UIColor(red: 1.0, green: 0.7, blue: 0.85, alpha: 1.0) // rosa
    ...
    let tituloLabel: UILabel = {
        ...
        label.textColor = UIColor(red: 0.6, green: 0.4, blue: 0.7, alpha: 1.0) // lilás
    ...
    let userTextField: UITextField = {
        ...
        tf.backgroundColor = UIColor(red: 1.0, green: 0.95, blue: 0.97, alpha: 1.0)
    ...
    let loginButton: UIButton = {
        ...
        button.backgroundColor = UIColor(red: 0.9, green: 0.8, blue: 0.9, alpha: 1.0) // lilás
    ...
    override init(frame: CGRect) {
        ...
        backgroundColor = UIColor(red: 1.0, green: 0.97, blue: 0.99, alpha: 1.0) // fundo rosinha
        setupHierarchy()
        setupConstraints()
    }
    ...
    func setLoginEnabled(_ isEnabled: Bool) {
        ...
        UIView.animate(withDuration: 0.2) {
            self.loginButton.backgroundColor = isEnabled
                ? UIColor(red: 1.0, green: 0.6, blue: 0.8, alpha: 1.0)
